  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
      <div className="rounded-xl bg-white p-8 shadow-sm">
        ...
        <h2 className="mb-2 text-xl font-bold text-gray-900">Pagina niet gevonden</h2>
        <p className="mb-6 text-sm text-gray-500">Deze pagina bestaat niet of is verplaatst.</p>
        <Link
          href="/"
