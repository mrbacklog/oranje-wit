                ...
                >
                  <div>
                    <Link
                      ...
                      className="text-sm font-medium text-gray-900 hover:text-ow-oranje hover:underline"
                    >
                      {[lid.roepnaam, lid.tussenvoegsel, lid.achternaam]
                        .filter(Boolean)
                        .join(" ")}
                    </Link>
                    <span
                ...
                >
                  ...
                  <span className="text-xs text-gray-400">
                    ...
                    <span className="text-gray-300">
                      ({lid.laatsteSeizoen.slice(2, 4)}/
                      {lid.laatsteSeizoen.slice(7, 9)})
                    </span>
                  </span>
                </li>
              ))}
