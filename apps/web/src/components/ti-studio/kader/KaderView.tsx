...
export function KaderView({
  ...
  const [hoofdTab, setHoofdTab] = useState<HoofdTab>("kaders");
  ...
  const totalOpenMemos =
    tcAlgemeenMemos.filter((w) => w.status === "OPEN" || w.status === "IN_BESPREKING").length +
    Object.values(memosPerDoelgroep)
      .flat()
      .filter((w) => w.status === "OPEN" || w.status === "IN_BESPREKING").length;
  ...
  return (
    ...
    >
        ...
        {hoofdTab === "kaders" && (
          <button
            ...
            style={{
              ...
              boxShadow: isDirty ? "0 1px 4px rgba(0,0,0,.25)" : "none",
            }}
          >
            {opslaanLabel()}
          </button>
      ...
      >
        {(
          [
            { id: "kaders", label: "Teamkaders" },
            { id: "memos", label: "Memo's & Aandachtspunten", count: totalOpenMemos },
          ] as const
        ).map((tab) => {
          const isActief = hoofdTab === tab.id;
          return (
            <button
              key={tab.id}
              onClick={() => setHoofdTab(tab.id)}
              style={{
                display: "flex",
                alignItems: "center",
                gap: 7,
                padding: "0 14px",
                border: "none",
                borderBottom: isActief ? "2px solid var(--accent)" : "2px solid transparent",
                marginBottom: -2,
                fontSize: 13,
                fontWeight: isActief ? 700 : 400,
                cursor: "pointer",
                background: "none",
                color: isActief ? "var(--text-1)" : "var(--text-3)",
              ...
              {"count" in tab && tab.count > 0 && (
                <span
                  style={{
                    ...
                    padding: "1px 6px",
                    borderRadius: 8,
                    background: isActief ? "var(--accent-dim)" : "var(--bg-3)",
                    color: isActief ? "var(--accent)" : "var(--text-3)",
                  }}
                >
                  ▲ {tab.count}
                </span>
        ...
        <>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    border: "none",
                    borderBottom: isActief ? `2px solid ${tt.kleurCss}` : "2px solid transparent",
                    fontSize: 12,
                    fontWeight: isActief ? 600 : 400,
                    cursor: "pointer",
                    background: isActief ? `${tt.kleurCss}14` : "none",
                    color: isActief ? "var(--text-1)" : "var(--text-2)",
                    whiteSpace: "nowrap",
                    flexShrink: 0,
                    position: "relative",
          ...
          <div
            style={{
              ...
              gap: 14,
              flexShrink: 0,
              borderLeft: `4px solid ${actief.kleurCss}`,
          ...
          >
            <div
              style={{
                ...
                height: 40,
                borderRadius: 8,
                background: actief.kleurCss + "20",
                border: `1.5px solid ${actief.kleurCss}50`,
                display: "flex",
                alignItems: "center",
            ...
            >
              <div
                style={{ width: 16, height: 16, borderRadius: "50%", background: actief.kleurCss }}
              />
            </div>
            <div>
              <div style={{ fontWeight: 700, fontSize: 15, lineHeight: 1.2 }}>{actief.label}</div>
            ...
            <div style={{ marginLeft: "auto", display: "flex", gap: 6 }}>
              ...
              <span
                style={{
                  ...
                  fontWeight: 600,
                  background: actief.kleurCss + "20",
                  color: actief.kleurCss,
                  border: `1px solid ${actief.kleurCss}40`,
                }}
              >
                {actief.doelgroep}
              </span>
