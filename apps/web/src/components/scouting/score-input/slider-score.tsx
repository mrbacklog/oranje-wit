  ...
  return (
    <div id={id} className="flex flex-col">
      ...
      <div className="relative mt-4 w-full px-1">
        ...
        <div
          className={`bg-surface-card absolute -top-7 -translate-x-1/2 rounded-md border px-2 py-0.5 shadow-none transition-all duration-150 ${isDragging ? "border-ow-oranje scale-110 font-extrabold shadow-md" : "border-border-subtle"} `}
        ...
        <input
          ...
          className={`focus-visible:ring-ow-oranje [&::-webkit-slider-thumb]:border-ow-oranje [&::-moz-range-thumb]:border-ow-oranje [&::-moz-range-thumb]:bg-surface-card [&::-webkit-slider-thumb]:bg-surface-card absolute inset-0 h-2 w-full cursor-pointer appearance-none bg-transparent outline-none focus-visible:ring-2 [&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:shadow-md [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:duration-100 ${isDragging ? "[&::-webkit-slider-thumb]:ring-ow-oranje/20 [&::-webkit-slider-thumb]:scale-125 [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:ring-4" : ""} ${disabled ? "cursor-not-allowed opacity-50" : ""} `}
        />
          ...
          return (
            <button
              ...
              className={`rounded-full border px-3 py-1.5 text-xs font-medium transition-all duration-150 active:scale-95 ${
                disabled
                  ? "border-border-subtle bg-surface-card text-text-muted cursor-not-allowed opacity-50"
                  : isActief
