...
export default function BesluitenOverzicht({
  ...
  function handleStatusChange(besluit: BesluitRecord, newStatus: BesluitStatus) {
    ...
    setStats((prev) => ({
      ...prev,
      [besluit.status.toLowerCase()]: Math.max(
        0,
        (prev[besluit.status.toLowerCase() as keyof typeof prev] as number) - 1
      ),
  ...
  function renderBesluit(besluit: BesluitRecord) {
    ...
    return (
      <div key={besluit.id} className="rounded-lg border border-neutral-700 bg-neutral-800/50 p-4">
              ...
              <div className="mt-2">
                ...
                <div className="mt-1 flex gap-2">
                  <button
                    ...
                    className="bg-ow-oranje rounded px-3 py-1 text-xs text-white hover:bg-orange-600"
                  >
                    Opslaan
                  </button>
                  <button
  ...
  const percentage = stats.totaal > 0 ? Math.round((stats.definitief / stats.totaal) * 100) : 0;
    ...
    <div className="space-y-6">
        ...
        <div className="h-3 overflow-hidden rounded-full bg-neutral-700">
          <div className="flex h-full">
            <div
              ...
              style={{
                width: `${stats.totaal > 0 ? (stats.definitief / stats.totaal) * 100 : 0}%`,
              }}
            />
            <div
      ...
      {besluiten.length === 0 && (
        <div className="rounded-lg border border-dashed border-neutral-600 p-8 text-center">
          <p className="mb-4 text-neutral-400">Nog geen besluiten voor deze blauwdruk.</p>
          <button
            ...
            <div className="rounded-lg border border-neutral-600 bg-neutral-800/50 p-4">
              ...
              <div className="mt-2 flex gap-2">
                <button
                  ...
                  className="bg-ow-oranje rounded px-3 py-1.5 text-xs font-medium text-white hover:bg-orange-600 disabled:opacity-50"
                >
                  Toevoegen
                </button>
                <button
