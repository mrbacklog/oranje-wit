    ...
    <div className="dialog-overlay">
      ...
      >
        <div className="dialog-header">
          <h3 className="text-lg font-bold text-gray-900">Nieuwe what-if</h3>
        ...
        <div className="dialog-body">
          {/* Vraag */}
          <div>
            <label htmlFor="whatif-vraag" className="mb-1 block text-sm font-medium text-gray-700">
          ...
          <div>
            ...
            {teams.length === 0 ? (
              <p className="text-xs text-gray-400">Geen teams beschikbaar.</p>
            ) : (
                  ...
                  return (
                    <div key={cat}>
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-2 border-b border-gray-100 bg-gray-50 px-3 py-2 text-left text-xs font-semibold text-gray-600 hover:bg-gray-100"
                      >
                        <span
                      ...
                      {catTeams.map((team) => {
                        ...
                        return (
                          <label
                            key={team.id}
                            className={`flex cursor-pointer items-center gap-2 border-b border-gray-50 px-4 py-2 text-sm last:border-b-0 hover:bg-orange-50 ${
                              aan ? "bg-orange-50" : "bg-white"
                            }`}
                          >
                            <input
                              type="checkbox"
                            ...
                            />
                            <span className={aan ? "font-medium text-orange-800" : "text-gray-700"}>
                              {team.naam}
                            </span>
                          </label>
                        );
