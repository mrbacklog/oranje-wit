...
const sidebarConfig: SidebarConfig = {
  ...
  navigation: [
    { label: "Dashboard", href: "/monitor", icon: "📊" },
    { label: "Teams", href: "/monitor/teams", icon: "🏃" },
    { label: "Spelers", href: "/monitor/spelers", icon: "👤" },
    { label: "Samenstelling", href: "/monitor/samenstelling", icon: "👥" },
    { label: "Ledendynamiek", href: "/monitor/retentie", icon: "🔄" },
    { label: "Jeugdpijplijn", href: "/monitor/projecties", icon: "🎯" },
    { label: "Signalering", href: "/monitor/signalering", icon: "⚠️" },
  ],
  footer: {
