...
import { getSeizoenVerloop, type SeizoenVerloopLid } from "@/lib/monitor/queries/verloop";
...
export default async function SeizoenVerloopPage({
  ...
  return (
    <PageContainer animated>
      <div className="mb-6">
        <Link href="/monitor/retentie" className="hover:text-ow-oranje text-text-muted text-sm">
