...
const DOMEINEN: NavSection[] = [
  {
    title: "Planning",
    items: [
      { label: "Jaarkalender", href: "/jaarplanning/kalender", icon: "calendar" },
      { label: "Mijlpalen", href: "/jaarplanning/mijlpalen", icon: "checkCircle" },
      { label: "Trainingen", href: "/roostering/trainingen", icon: "flag" },
      { label: "Wedstrijden", href: "/roostering/wedstrijden", icon: "trophy" },
    ],
  },
  {
    title: "Teams",
    items: [
      { label: "Overzicht", href: "/teams", icon: "users" },
      { label: "Sportlink Sync", href: "/teams/sync", icon: "sync" },
    ],
  },
  {
    title: "Jeugd",
    items: [
      { label: "Raamwerk", href: "/jeugd/raamwerk", icon: "clipboard" },
      { label: "Progressie", href: "/jeugd/progressie", icon: "trendUp" },
      { label: "USS-parameters", href: "/jeugd/uss", icon: "barChart" },
    ],
  },
  {
    title: "Beoordeling",
    items: [
      { label: "Scouts", href: "/scouting/scouts", icon: "search" },
      { label: "Rondes", href: "/evaluatie/rondes", icon: "documentEdit" },
      { label: "Coordinatoren", href: "/evaluatie/coordinatoren", icon: "target" },
      { label: "Templates", href: "/evaluatie/templates", icon: "envelope" },
    ],
  },
  {
    title: "Groei",
    items: [
      { label: "Aanmeldingen", href: "/werving/aanmeldingen", icon: "userPlus" },
      { label: "Funnel", href: "/werving/funnel", icon: "funnel" },
    ],
  },
  {
    title: "Systeem",
    items: [
      { label: "Gebruikers", href: "/systeem/gebruikers", icon: "user" },
      { label: "Import", href: "/systeem/import", icon: "inboxDown" },
    ],
  },
  {
    title: "Archief",
    items: [
      { label: "Teamhistorie", href: "/archief/teams", icon: "bookStack" },
      { label: "Resultaten", href: "/archief/resultaten", icon: "award" },
    ],
  },
];
