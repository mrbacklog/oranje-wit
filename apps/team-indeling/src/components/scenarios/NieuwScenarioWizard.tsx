...
import {
  ...
  createLeegScenario,
  kopieerScenario,
} from "@/app/scenarios/wizard-actions";
import { berekenBTeamVoorstel, berekenLeeftijdVerdeling } from "@/lib/teamstructuur";
import type { SpelerBasis, ACatConfig, BTeamVoorstel } from "@/lib/teamstructuur";
...
type Methode = "blauwdruk" | "kopieer" | "leeg";
type WizardStap =
  | "methode"
  | "naam"
  | "senioren"
