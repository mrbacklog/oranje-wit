...
const D: Record<string, CategorieSettings> = {
  KANGOEROES: {
    minSpelers: 0,
    optimaalSpelers: 0,
    maxAfwijkingPercentage: 0,
    verplichtMinV: 0,
    verplichtMinM: 0,
    gewenstMinV: 0,
    gewenstMinM: 0,
    monogenderToestaan: true,
    gemiddeldeLeeftijdKernMin: 4.0,
    gemiddeldeLeeftijdKernMax: 6.0,
    gemiddeldeLeeftijdOverlapMin: 4.0,
  ...
  BLAUW: {
    ...
    gewenstMinM: 2,
    monogenderToestaan: true,
    gemiddeldeLeeftijdKernMin: 5.5,
    gemiddeldeLeeftijdKernMax: 7.5,
    gemiddeldeLeeftijdOverlapMin: 5.0,
  ...
  GROEN: {
    ...
    gewenstMinM: 2,
    monogenderToestaan: true,
    gemiddeldeLeeftijdKernMin: 7.5,
    gemiddeldeLeeftijdKernMax: 9.5,
    gemiddeldeLeeftijdOverlapMin: 7.0,
  ...
  GEEL: {
    ...
    gemiddeldeLeeftijdKernMin: 9.5,
    gemiddeldeLeeftijdKernMax: 12.0,
    gemiddeldeLeeftijdOverlapMin: 9.0,
  ...
  ORANJE: {
    ...
    gewenstMinM: 2,
    monogenderToestaan: false,
    gemiddeldeLeeftijdKernMin: 12.0,
    gemiddeldeLeeftijdKernMax: 13.5,
    gemiddeldeLeeftijdOverlapMin: 11.0,
  ...
  ROOD: {
    ...
    gewenstMinM: 2,
    monogenderToestaan: false,
    gemiddeldeLeeftijdKernMin: 13.5,
