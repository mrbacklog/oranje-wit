...
function leeftijdThema(categorie: string): LeeftijdThema {
  switch (categorie) {
    case "rood":
      return {
        borderGrad:
...
export function HoverKaartSpeler({
  ...
  const leeftijdDelen = speler.korfbalLeeftijd.split(".");
  const leeftijdJaar = leeftijdDelen[0] ?? "—";
  const leeftijdDec = leeftijdDelen[1] ? `.${leeftijdDelen[1]}` : "";
  ...
  return createPortal(
    ...
    >
      {/* Gradient-border via pseudo-equivalent — outer glow wrapper */}
      <div
        style={{
          position: "absolute",
          inset: -3,
      ...
      >
        ...
        {/* Header: [status links] · [leeftijd rechts] */}
        <div
          style={{
            position: "relative",
            zIndex: 5,
        ...
        {/* Foto/initialen vlak — edge-to-edge */}
        <div
          style={{
            position: "relative",
            zIndex: 2,
            ...
            margin: 0,
            overflow: "hidden",
            background: `linear-gradient(180deg, ${thema.bgTint}18 0%, #0a0a0c 100%)`,
          }}
        >
          {/* Initialen groot als avatar-placeholder */}
          <div
            style={{
              position: "absolute",
              inset: 0,
          ...
          {/* Gradient bovenaan foto (voor leesbaarheid header) */}
          <div
            style={{
              position: "absolute",
              top: 0,
