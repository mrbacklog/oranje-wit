...
import { VerzoekKaart } from "@/components/verzoek-kaart";
...
export default function VerzoekenPage() {
  ...
  const laadVerzoeken = useCallback(async () => {
    try {
      ...
      const res = await fetch("/api/mijn-verzoeken");
    ...
    <div className="min-h-screen bg-surface-dark pb-20">
      ...
      <div className="bg-surface-card px-4 pt-6 pb-4 shadow-none">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-text-primary">Verzoeken</h1>
          {isTC && (
            <button
              type="button"
      ...
      <div className="space-y-6 px-4 pt-4">
        ...
        {verzoeken.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm font-medium text-text-primary">Geen verzoeken</p>
