...
import {
  ...
  StapOpmerking,
  StapSamenvatting,
} from "@/app/(scout)/rapport/nieuw/[relCode]/wizard-stappen";
import type { ScoutingContext } from "@/app/(scout)/rapport/nieuw/[relCode]/wizard-stappen";
import { StapBeoordeling } from "@/app/(scout)/rapport/nieuw/[relCode]/wizard-beoordelingen";
    ...
    <div className="bg-surface-dark flex min-h-[calc(100dvh-4rem)] flex-col">
      ...
      <header className="border-border-subtle bg-surface-card border-b px-4 py-3">
        ...
        <SpelerContext
          ...
          fotoUrl={`/api/spelers/${speler.id}/foto`}
          compact
        />
      </header>
