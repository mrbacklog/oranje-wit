    ...
    <div className={`${cls} bg-surface-card animate-pulse overflow-hidden rounded-2xl`}>
      {size === "mini" ? (
        <div className="flex h-full flex-col items-center justify-center gap-1">
          <div className="h-6 w-6 rounded-full bg-surface-card/10" />
          <div className="h-2 w-8 rounded bg-surface-card/10" />
        </div>
      ) : (
        <div className="flex h-full flex-col items-center gap-2 pt-4">
          <div className="h-10 w-10 rounded-full bg-surface-card/10" />
          <div className="h-3 w-16 rounded bg-surface-card/10" />
          <div className="h-2 w-12 rounded bg-surface-card/10" />
        </div>
      )}
    </div>
  );
