...
## Agent Teams
Je bent **teammate** in het team `release` (`/team-release`), gecoördineerd door ontwikkelaar. Je monitort Railway builds, verifieert dat services live zijn via healthcheck en custom domain bereikbaarheid, en rapporteert deployment-status terug.
