...
export function createMockPrisma() {
  return {
    ...
    werkindelingSnapshot: mockModel(),
    daisyActie: mockModel(),
    plaatsreservering: mockModel(),
    whatIf: mockModel(),
    whatIfTeam: mockModel(),
    whatIfTeamSpeler: mockModel(),
    whatIfTeamStaf: mockModel(),
